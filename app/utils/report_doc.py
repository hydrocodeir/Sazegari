...
def load_doc(content_json: str | None) -> dict:
    if not content_json:
        return {"intro_html": "", "conclusion_html": "", "meta": {"title": "", "subtitle": ""}, "sections": [], "aggregation": {"submissions": [], "by_form": {}, "forms": {}}}
    try:
    ...
    if isinstance(obj, dict) and "submissions" in obj and "aggregation" not in obj:
        return {"intro_html": "", "conclusion_html": "", "meta": {"title": "", "subtitle": ""}, "sections": [], "aggregation": obj}
